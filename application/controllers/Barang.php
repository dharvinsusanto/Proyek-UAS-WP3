...
class Barang extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            // Karena tidak mengenerate ID barang, tidak perlu mendapatkan data barang berdasarkan ID
            ...
            // Pastikan ID barang diinputkan secara manual atau auto-increment oleh database
