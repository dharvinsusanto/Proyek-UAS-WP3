                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="barang_masuk">Transaksi Penerimaan</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input value="barang_keluar" type="radio" id="barang_keluar" name="transaksi" class="custom-control-input">
                            <label class="custom-control-label" for="barang_keluar">Transaksi Pengeluaran</label>
                        </div>
